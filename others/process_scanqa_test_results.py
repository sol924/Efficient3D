...
preds = json.load(
    open(
        "/mnt/petrelfs/my_username/share_hw/Chat-3D-v2/outputs/20240802_152505_lr5e-6_ep3_scanrefer#scan2cap#obj_align#scanqa#sqa3d#multi3dref#nr3d_caption__scanqa#scanqa_test__eval/preds_epoch-1_step0_scanqa_test.json",
        "r",
    )
)
