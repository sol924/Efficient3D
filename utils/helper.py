...
def scanrefer_get_unique_multiple_lookup():
    unique_multiple_lookup_file = '/gpfs/work/cpt/yuhuilin21/PointLLM/dataset/annotations/scanrefer_unique_multiple_lookup.json'
    if not os.path.exists(unique_multiple_lookup_file):
        ...
        raw2label = {}
        with open('/gpfs/work/cpt/yuhuilin21/PointLLM/dataset/annotations/scannet/scannetv2-labels.combined.tsv', 'r') as f:
        ...
        scanrefer_data = json.load(open('/gpfs/work/cpt/yuhuilin21/PointLLM/dataset/annotations/scanrefer/ScanRefer_filtered.json'))
