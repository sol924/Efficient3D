...
def calc_scanrefer_score(preds, config=None):
    ...
    scannet_attribute_file = "/gpfs/work/cpt/yuhuilin21/PointLLM/dataset/annotations/scannet_val_attributes.pt"
...
def calc_scan2cap_score(preds, tokenizer, scorers, config=None):
    ...
    gt_dict = json.load(open("/gpfs/work/cpt/yuhuilin21/PointLLM/dataset/annotations/scan2cap_val_corpus.json"))
    tmp_preds_iou25 = {}
    tmp_preds_iou50 = {}
    tmp_targets = {}
    for pred in preds:
...
def calc_scanqa_score(preds, tokenizer, scorers, config=None):
    with open(f"/gpfs/work/cpt/yuhuilin21/PointLLM/dataset/annotations/scanqa/ScanQA_v1.0_val.json", "r") as f:
        annos = json.load(f)
    outputs = []
    qset = set()
    val_scores = {}
...
#
#     saved_preds = json.load(
#         open(
#             "/mnt/petrelfs/my_username/share/Chat-3D-v2/outputs/20240504_213518_lr5e-6_ep3_scanrefer#scan2cap#obj_align#scanqa#sqa3d#multi3dref#scannet_caption#scannet_region_caption#nr3d_caption__scanrefer#scan2cap#scanqa#multi3dref#sqa3d__mask3d_video/preds_epoch1_step3812_scanqa.json"
#         )
#     )
#     scorers = [
