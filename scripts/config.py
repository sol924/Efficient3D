# ========================= data ==========================
anno_root = "/gpfs/work/cpt/yuhuilin21/PointLLM/dataset/annotations"  # annotation dir
pc_encoder = "uni3d"
segmentor = "mask3d"
version = ""
...
optimizer = dict(
    ...
    different_lr=dict(
        enable=False, module_names=["model.embed_tokens"], lr=[5e-4], wd=[0.02]
    ),
)
...
wandb = dict(
    enable=False,
    entity="my_username",  # username or team name to store the runs, see https://docs.wandb.ai/ref/python/init
    project="Scene-LLM",
)
dist_url = "env://"
device = "cuda"
...
# ========================= fast inference ==========================
random_drop_rate = 0
fast_v_attention_rank = 300
use_fast_v = False
fast_v_agg_layer = 2
use_fast_v_oracle = False
token_pruning = True

use_external_attn_maps = False
val_attn_maps_path = ""
use_a_map_ori = False

adaptive_rank_alpha = 0
